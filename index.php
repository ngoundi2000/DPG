	 ...
	 <ul class="rslides callbacks callbacks1" id="slider4">
								<li>
									<div class="agileits-banner-info">
										<h3>Instructional
											<div class="border"></div> <span>Platform</span></h3>
										<div class="w3-button">
											<div class="w3ls-button">
												<a href="#contact" class="scroll hvr-shutter-out-vertical">lOGIN</a>
											</div>
											<div class="w3l-button">
												<a href="#contact" class="scroll hvr-shutter-out-vertical">REGISTRATION</a>
											</div>
								...
								<li>
									<div class="agileits-banner-info">
										<h3>Welcome
											<div class="border"></div> <span>to FCS500 FORUM</span></h3>
										<div class="w3-button">
											<div class="w3ls-button">
												<a href="#contact" class="scroll hvr-shutter-out-vertical">LOGIN</a>
											</div>
		...
		<div class="container">
			<div class="w3l-about-grids_inner">
				<div class="col-md-6 w3ls-about-left">
					<h2>Welcome to FCS500 Forum</h2>
					<h6>this is an instructional space that enables computer students of HTTTC Bambili to exchange and debate on crutial topics.</h6>
					<p>Subject debated are mostly hot topic of computer . Artificial intelligenge, grahph theory, microcontroller, cryptography
						, embedded system, applied didactics and many others constitute the main areas of discussion.If you think you are able to contribute or that this can be usefull for you please feel
						free to join us for a critical thinking adventure</p>
					<p>To become a member, you just need to be a lecturer or a student of Fundamental Computer Science level 500. Nevertheless
					anybody who thinks that he is able, he can just create an account and wait. All created account will be validated by the class coordinator be being 
					usefull.</p>
					<a href="#contact" class="scroll hvr-shutter-out-vertical">Registration</a>
				</div>
	...
	<div class="team" id="team">
		<div class="container">
			<div class="about-heading two">
				<h3>KEY ACTORS</h3>
				<p>Delegates and heads of computer club</p>
			</div>
			<div class="team-grids">
				<div class="col-md-3 agileinfo-team-grid">
					<img src="images/t1.jpg" alt="">
					<div class="captn">
						<h4>Lonlac Vanessa</h4>
						<p>head of comptuter science club </p>
				...
				<div class="contact-w3ls-row">
					<form action="forum.php" method="post">
						<div class="col-md-5 col-sm-5 contact-right agileits-w3layouts">
							 Log in<hr> 
							<input class="email" name="name" type="email" placeholder="Email" required="">
							  
							<input class="password" name="pass" type="text" placeholder="Password" required="">
						...
						<div class="col-md-7 col-sm-7 contact-left agileits-w3layouts">
						 Registration<hr> 
							...
							<input class="email" name="pass" type="text" placeholder="Password" required="">
